...
Optional packages are installed with `agentshield[langgraph]`, `agentshield[microsoft-agent-framework]`, or `agentshield[frameworks]`. The controlled adapter harness does not require those packages.
